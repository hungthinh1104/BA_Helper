      ...
      <header className="landing-nav bg-surface/70 backdrop-blur-md sticky top-0 z-50 border-b border-border/40">
        <div className="max-w-6xl mx-auto px-4 landing-nav-inner flex items-center justify-between h-16">
          ...
          <div className="landing-nav-links flex items-center gap-6">
            ...
            <Link href="/app/analyses/mock-analysis-123" className="text-sm font-medium bg-foreground text-background px-4 py-2 rounded-full hover:bg-foreground/90 transition-colors">Try Demo</Link>
          </div>
        </div>
      </header>
        ...
        <div className="max-w-6xl mx-auto px-4 grid md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              <li><Link href="/app/analyses" className="hover:text-primary">Impact Analysis</Link></li>
              <li><Link href="/app/repositories" className="hover:text-primary">Repository Snapshots</Link></li>
              <li><Link href="/app/reports" className="hover:text-primary">Traceability Reports</Link></li>
            </ul>
          </div>
          <div>
