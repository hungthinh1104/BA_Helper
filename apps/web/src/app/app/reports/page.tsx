...
export default function ReportsPage() {
  ...
  const selectedDoc = completedAnalyses.find(d => d.id === selectedAnalysisId)
      ...
      <div className="app-page-scroll">
        ...
        <DataList>
          ...
          {completedAnalyses.map((doc) => (
            <Dialog key={doc.id} onOpenChange={(open) => { if(open) setSelectedAnalysisId(doc.id); else setSelectedAnalysisId(null); }}>
                ...
                <div className="flex flex-col h-full">
                  ...
                  <div className="h-14 border-b border-border/60 bg-surface/50 backdrop-blur-md flex items-center justify-between px-6 shrink-0 z-10 print:hidden">
                    <div className="flex items-center gap-3">
                      <span className="font-semibold text-sm text-foreground">Report View</span>
