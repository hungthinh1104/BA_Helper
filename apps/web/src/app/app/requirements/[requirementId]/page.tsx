...
import { ReadinessStatusBadge } from "@/components/workspace/new-requirement-dialog"
...
export default function RequirementDetailsPage({ params }: { params: Promise<{ requirementId: string }> }) {
  ...
  const { data: req, isLoading, error } = useRequirementDetail("default-project", requirementId)
  ...
  return (
    <AppShell>
      <div className="app-page-scroll">
        ...
        <BackButton href="/app/requirements" label="Back to Requirements" className="mb-0" />
        ...
        >
          <div className="flex items-center gap-2">
            ...
            <NewAnalysisDialog preselectedReqId={req.id}>
              <Button size="sm" className="h-8 shadow-none gap-1.5" disabled={!isReady}>
