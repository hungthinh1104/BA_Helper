  ...
  return (
    <div className="mt-3 border border-border rounded-lg overflow-hidden bg-surface flex flex-col shadow-sm">
      ...
      <div className="p-3 flex flex-col gap-3 text-[12px] leading-relaxed">
        <div>
          <span className="font-semibold text-foreground mr-1.5">Why:</span>
        ...
        {suggestion.qaFocus && (
          <div>
            <span className="font-semibold text-foreground mr-1.5">QA Focus:</span>
        ...
        {suggestion.baQuestion && (
          <div>
            <span className="font-semibold text-foreground mr-1.5">BA Question:</span>
