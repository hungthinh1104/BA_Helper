...
let EvidenceController = class EvidenceController {
    constructor(listEvidence) {
        this.listEvidence = listEvidence;
    }
    async list(analysisId) {
        const items = await this.listEvidence.execute(analysisId);
        return contracts_1.evidenceListResponseSchema.parse({ items: (0, evidence_mapper_1.mapEvidenceList)(items) });
    }
};
exports.EvidenceController = EvidenceController;
__decorate([
    (0, common_1.Get)('/impact-analyses/:analysisId/evidence'),
...
exports.EvidenceController = EvidenceController = __decorate([
    ...
    __metadata("design:paramtypes", [list_evidence_usecase_1.ListEvidenceUseCase])
], EvidenceController);
