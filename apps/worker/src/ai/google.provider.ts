...
import { z } from 'zod';
import { LlmProviderPort, LlmRequest, LlmResult, AiOutputError } from '@ba-helper/application';
import { AiConfig, AI_CONFIG_TOKEN } from './ai-config';
import { AiPolicy, AppError } from '@ba-helper/shared';
import { parseStructuredLlmOutput } from './structured-output';

@Injectable()
export class GoogleLlmProvider extends LlmProviderPort {
